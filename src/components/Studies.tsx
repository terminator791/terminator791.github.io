  ...
  const educationData = [
    {
      ...
      description:
        "Focused on software engineering, web developer, data structures, and system design. Maintained strong academic performance while working on various practical projects that bridge theory with real-world applications.",
      highlights: [
