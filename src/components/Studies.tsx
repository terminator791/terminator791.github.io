  ...
  const educationData = [
    {
      ...
      description:
        "Focused on software engineering, web development, data structures, and system design. Maintained strong academic performance while working on various practical projects that bridge theory with real-world applications.",
      highlights: [
        "Maintained GPA of 3.92/4.00 throughout academic journey",
        "Specialized in Machine Learning Engineer & Web Developer",
        "Developed strong foundation in Web Developer",
    ...
    },
    {
      ...
      description:
        "Specialized in Computer and Network Engineering with a strong focus on practical skills and foundational programming.",
      highlights: [
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            <motion.div
              ...
              className="p-3 bg-blue-600 rounded-lg text-white shadow-lg"
            >
        ...
        <Timeline items={educationData} title="Academic Excellence" />
        ...
        >
          ...
          >
            ...
            technologies. My approach combines solid theoretical foundations
            with hands-on practical experience, always seeking to understand not
            just the "how" but also the "why" behind every concept. This
            philosophy has enabled me to maintain academic excellence while
