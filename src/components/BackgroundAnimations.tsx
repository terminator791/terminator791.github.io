...
const BackgroundAnimations: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      ...
      {/* Pulsing orbs */}
      <motion.div
        className="absolute top-1/4 left-1/4 w-32 h-32 bg-blue-500/5 rounded-full blur-2xl"
        animate={{
          scale: [1, 1.5, 1],
          opacity: [0.3, 0.6, 0.3],
        }}
      ...
      <motion.div
        className="absolute bottom-1/4 right-1/4 w-40 h-40 bg-purple-500/5 rounded-full blur-2xl"
        animate={{
          scale: [1, 1.3, 1],
          opacity: [0.2, 0.5, 0.2],
        }}
      ...
      <motion.div
        className="absolute top-3/4 left-1/2 w-24 h-24 bg-green-500/5 rounded-full blur-2xl"
        animate={{
          scale: [1, 1.4, 1],
          opacity: [0.4, 0.7, 0.4],
        }}
